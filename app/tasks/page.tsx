  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-400">
            My Tasks
          </h1>
      ...
      {showForm && (
        <div className="mb-8 glass backdrop-blur-lg rounded-xl p-6 border border-violet-500/30 shadow-lg shadow-violet-500/20 dark:shadow-violet-500/30">
      ...
      <div className="glass backdrop-blur-lg rounded-xl p-6 border border-violet-500/30 shadow-lg shadow-violet-500/20 dark:shadow-violet-500/30">
